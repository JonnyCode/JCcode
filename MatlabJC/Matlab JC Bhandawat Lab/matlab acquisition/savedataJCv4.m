...
global fromEphys
persistent voltage current Ao0 Ao1 
...
tempAo0 = event.Data(:,1) ;
tempAo1 = event.Data(:,5) ;
...
if length(voltage) == fromEphys.lt ;
    % save data
    dataStruct.TrialId = fromEphys.TrialId ;
    dataStruct.voltage = voltage ;
    dataStruct.current = current ;
    dataStruct.Ao0 = Ao0 ;
    dataStruct.Ao1 = Ao1 ;
    dataStruct.Trigtime = Trigtime ;
    dataStruct.TrialTag = fromEphys.TrialTag ;
    
    save(fromEphys.TrialId,'dataStruct');
    
    % clear peristent variables
    clear voltage current Ao0 Ao1 
