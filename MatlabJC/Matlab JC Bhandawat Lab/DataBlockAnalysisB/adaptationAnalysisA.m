function ForIgor = adaptationAnalysisA(Input,A,AnalysisFlag)

% adaptation of "ORNadaptationAnalysisC/ PNadaptationAnalysisK" 
% combines PN and ORN into one analysis and separates with a flag also save data as single where necessary to save data space 
