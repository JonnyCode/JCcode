...
extern NSString *BWPluginLoadedNotification;
extern NSString *BWPluginUnloadedNotificaiton;

// keys in NSNotification.userInfo for the BWPlugin*Notification
extern NSString *BWPluginClassKey;
extern NSString *BWPluginTypeKey;
extern NSString *BWPluginClassNameKey;
