...
extern NSString * const KVPValueTypeKey;
extern NSString * const KVPValueRequiredProtocolKey;
extern NSString * const KVPValueKeyKey;
extern NSString * const KVPManagedObjectClassKey;
...
+ (NSSet*)queriableValuePropertyNames;
+ (NSDictionary*)queriableValuePropertiesByName;
