...
extern NSString *BWAppDelegateNewTicketURL;
extern NSString *BWAppDelegatePrefsNibName;
extern NSString *BWAppDelegateSplashNibName;
extern NSString *BWAppDelegateRedirectLogsURLKey;
extern NSString *BWAppDelegateShowDebugLogKey;
extern NSString *BWAppDelegateAppShouldOpenUntitledDocumentKey;
