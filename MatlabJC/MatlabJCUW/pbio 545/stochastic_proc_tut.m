...
%
% Michael N. Shadlen
% Neubeh545  February, 2005 (see below for version history)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% 2/12/05 MNS updated, mainly the markov chain bit.
%
% Dependencies: 
...
% Homework problem. Write a differential equation to capture the idea
