function ForIgor = dcLIF(Input,Parameters,id,A) 
...
V_trace = LIFmodelG(Gexc,Ginh,10,1/MSI) ;
...
for a=1:size(V_trace,1) ;
    identifier = ['LIFtrace',num2str(a),id,num2str(A)] ;
    ForIgor.(identifier) = V_trace(a,:) ; 
    
    identifier = ['DCtrace',num2str(a),id,num2str(A)] ;
