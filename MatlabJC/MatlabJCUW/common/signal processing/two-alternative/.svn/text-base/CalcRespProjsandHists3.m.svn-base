function RespProjection = CalcRespProjsandHists3(CellInfo, FlashConditionA, FlashConditionB, NoiseCondition, FreqCutoff, RespLength, shuffles)
%
...
for cond=1:NumFlashConds
	Projections = Calculate2AFCRespProjection3(CellInfo, FlashConditionA, FlashConditionB, NoiseCondition, cond, FreqCutoff, RespLength, shuffles);
