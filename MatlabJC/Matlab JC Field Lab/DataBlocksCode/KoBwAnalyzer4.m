function ForIgor = KoBwAnalyzer4(DataBlock, DB, Params)

% this function is modified from 'KoBwAnalyzer3'. 
% rearranged so that parameters from mapped cells were compared.
