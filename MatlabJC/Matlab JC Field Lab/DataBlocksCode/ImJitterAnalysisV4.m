function ForIgor = ImJitterAnalysisV4(DataBlock, DB, Params)

% edited from "ImJitterAnalysisV3" 
% calculate STAs based on crosscorrelation (instead of estamated time)
% added stim integration analysis (StimBinNum),
% changed path and save for DS selection,
% added OnDsFlag
% added QuadLoop to replace 'TEMP_LOOP'
% added 'UseImportDsIdsPath'
