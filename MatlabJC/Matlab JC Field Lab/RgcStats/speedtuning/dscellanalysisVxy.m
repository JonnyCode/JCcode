function[ds_struct] = dscellanalysisVxy(NumSpikesCell, StimComb,datarun)
...
spperiods = unique(cell2mat(StimComb(:,1)));
...
for i = 1:length(spperiods)
    ...
    inn = ismember(cell2mat(StimComb(:,1)), spperiods(i))';
    NumSpikesCell2 = NumSpikesCell(:,inn);
    StimComb2 = StimComb(inn',:);
    
[rho1, theta1, num_t, num_c] = get_rhothetaVxy(NumSpikesCell2, StimComb2,datarun);
RHO1 = rho1;
