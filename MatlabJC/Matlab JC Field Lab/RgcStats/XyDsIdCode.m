...
dataRun = load_stimVxy(dataRun,'user_defined_trigger_interval', TrialTrigInterval) ;
...
ds_struct.mag = dscellanalysisWithFigs(NumSpikesCell, StimComb); % plot vector sums for each speed
