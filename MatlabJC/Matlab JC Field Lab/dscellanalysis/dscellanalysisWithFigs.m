function[mag dsindex magmax magave angle rho theta num U V spave] = dscellanalysisWithFigs(NumSpikesCell, StimComb)
...
spave = cell(length(unique(StimComb(:,2))), length(unique(StimComb(:,1))));
...
dsindex1 = DSI_finder(mag1,rho1) ; % JC code for dsi
