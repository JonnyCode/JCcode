function [T, psth, bins] = get_psth_sr(spike_times, trial_begin_times, varargin)
%
% psth_gdf(datarun,cell_specification,trigger,varargin)
% Sneha's version, one more output - T (raw spike times for each trial,
% shifted from 0 to length of trial)
% 
...
%   hist_bin    0.1        bins size of PSTH
...
T = cell(length(trial_begin_times),1);
